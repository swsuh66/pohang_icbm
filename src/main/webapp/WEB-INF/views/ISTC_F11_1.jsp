...
<script type="text/javascript">
	...
	*/
	...
	function loadData(qid, params, callback) {
		...
		var qid = qid ? qid : 'mars.icbm.map1.select_waterLeakList_page';
...
<div role="main" class="sub-content">
	<%@ include file="ISTC_F11_1_CONTENT.jsp" %>
		        	...
		        	<div class="modal-body">
						<div class="bcard ccard  overflow-hidden settingGrid">
									...
									<div class="col-sm-12">
									  <div class="form-group row">
										<div class="col-sm-2 col-form-label text-sm-right pr-0">
											<label class="mb-0" for="calc_hour">기준시간</label>
										</div>
										<div class="col-sm-4">
		                                    <input type="text" class="form-control" id="calc_hour">
										</div>
										<div class="col-sm-2 col-form-label text-sm-right pr-0">
											<label class="mb-0" for="pipe_diameter">구경</label>
										</div>
										<div class="col-sm-4">
								      ...
								      <div class="form-group row">
								      	<div class="col-sm-2 col-form-label text-sm-right pr-0">
											<label class="mb-0" for="business_name">업종</label>
										</div>
										<div class="col-sm-4">
		                                    <select data-placeholder="선택" class="form-control" name="1" id="business_name" data-component="business_name" >
											</select>
										</div>
										<div class="col-sm-2 col-form-label text-sm-right pr-0">
											<label class="mb-0" for="compare_term_cv">최소 사용량</label>
										</div>
										<div class="col-sm-4">
		                                    <input type="text" id="compare_term_cv" class="form-control">
										</div>
									  </div>
									  <div class="row">
									  	<div class="col-sm-12 ">
							...
							<div class="card-body p-0 bgc-whit flex-grow-1">
								<div id="settionContainer" class="card-body p-0">					
									<div id="settingGrid" class="data-list containerBorder"></div>
								</div>
							</div>
						</div>
			         </div>
