                            ...
                            <div class="card ccard no-border">
                                <ul class="nav nav-tabs nav-tabs-simple nav-tabs-scroll border-b-1 brc-dark-l3 mx-0 mx-md-0 px-3 px-md-1 pt-2px"
                                    ...
                                    <li class="nav-item mr-1">
                                        <a class="nav-link active p-3 bgc-h-primary-l4 radius-0"
                                           id="home16-tab-btn" data-toggle="tab" href="#home16" role="tab"
                                           aria-controls="home16" aria-selected="true">
                                    ...
                                    <li class="nav-item mr-1">
                                        <a class="nav-link brc-purple-m1 d-style p-3 bgc-h-purple-l4 radius-0"
                                           id="profile18-tab-btn" data-toggle="tab" href="#profile18"
                                           role="tab" aria-controls="profile18" aria-selected="false">
                                    ...
                                    <li class="nav-item mr-1">
                                        <a class="nav-link brc-purple-m1 d-style p-3 bgc-h-purple-l4 radius-0"
                                           id="profile17-tab-btn" data-toggle="tab" href="#profile17"
                                           role="tab" aria-controls="profile17" aria-selected="false">
                                            <i class="fa text-purple mr-3px"></i>
                                            부수용가
                                        </a>
                                    </li>
                                    <li class="nav-item mr-1">
                                        <a class="nav-link brc-purple-m1 d-style p-3 bgc-h-purple-l4 radius-0"
                                           id="profile19-tab-btn" data-toggle="tab" href="#profile19"
                                           role="tab" aria-controls="profile19" aria-selected="false">
                                            <i class="fa text-purple mr-3px"></i>
                                            비고
                                        </a>
                                    </li>
                                    ...
                                    <li class="full-width item-vertical-center">
                                        ...
                                        <div class="dj-btn-group">
											<div class="d-flex align-items-center px-lg-0">
                                                <a href="#none" title="이전 수용가"
                                                   class="btn dj-btn-outline-gray btn-sm"
                                                   onclick="beforeData();">이전 수용가</a>
											</div>
                                            <div class="d-flex align-items-center px-lg-0">
                                                <div class="card-toolbar align-self-center no-border">
                                                    <div class="dropdown dd-backdrop dd-backdrop-none-md">
                                                        <a class="btn btn-light-green text-600 btn-xs mr-1"
                                                           href="#" role="button" data-toggle="dropdown"
                                                           data-display="static" aria-haspopup="true"
                                                           aria-expanded="false" onclick="dataDownload();">
                                                            Export
                                ...
                                <div class="card-body px-0 py-2">
                                    <div class="tab-content border-0 px-0 no-border" style="min-height: 160px; max-height: 700px;">
                                        <div class="tab-pane show active text-95 px-25" id="home16"
                                            role="tabpanel" aria-labelledby="home16-tab-btn">
                                            <div class="dj-card" id="filter">
                                                <div class="row">
                                                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
                                                        <div class="dj-input-group">
                                                            <span class="info componentsFont">구분</span>
                                                            <select data-placeholder="선택" id="typeSelect"
                                                                class="form-control border-1p" style="width:200px;">
                                            ...
                                            <div class="bcard card  point-grid" style="">
                                                <ul class="nav nav-tabs custom-nav-tabs" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active custom-nav-link" id="datatable-tab-btn"
                                                        data-toggle="tab" href="#datatable" role="tab" aria-controls="datatable"
                                                        aria-selected="true">테이블
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link custom-nav-link" id="datachart-tab-btn"
                                                        data-toggle="tab" href="#datachart" role="tab" aria-controls="datachart"
                                                ...
                                                <div class="tab-content tab-sliding border-0 px-0">
                                                    <div class="tab-pane show active text-95 px-25" id="datatable" role="tabpanel" aria-labelledby="datatable-tab-btn">
                                                        <div class="" id="modalGridContainer">
                                                            <div id="useGrid" class="data-list containerBorder"
                                                                style="min-height: 160px; max-height: 650px;"></div>
                                                        </div>
                                                    </div>
                                                    <div class="tab-pane show active text-95 px-25" id="datachart" role="tabpanel" aria-labelledby="datachart-tab-btn">
                                                        <div id="useChart" class="containerBorder"
                                                        style="min-height: 160px; max-height: 650px;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane text-95 px-25" id="profile17" role="tabpanel"
                                            ...
                                            <div class="" id="modalGridContainer2">
                                                <div id="useGrid2" class="data-list containerBorder"
                                                style="width: 100%; height: 100%;"></div>
                                            </div>

                                        </div>
                                        <div class="tab-pane text-95 px-25" id="profile19" role="tabpanel"
                                             aria-labelledby="profile19-tab-btn">
                                            <div class="">
                                                <div class="data-list containerBorder" style="width: 100%; height: 100%;">
                                                    <textarea id="note_bigo" style="width: 100%; height: 100%;" ></textarea>
                                                </div>
                                                <div class="dj-btn-group">
                                                    <a class="btn dj-btn-primary btn-sm" onclick="bigoUpdate();"> 
                                                        저장					
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane text-95 px-25" id="profile18" role="tabpanel"
                                             aria-labelledby="profile18-tab-btn" style="overflow:scroll;">
