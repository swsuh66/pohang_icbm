    ...
    <div class="row">
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
            <div class="dj-input-group">
                <span class="info componentsFont">메시지</span>
                <input type="text" class="componentsSelect" id="log_mesg" name="log_mesg" onKeypress="javascript:if(event.keyCode == 13) { parent.searchGrid(); }"/>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
            <div class="dj-input-group">
                <span class="info componentsFont">이름</span>
                <input type="text" class="componentsSelect" id="log_name" name="log_name" onKeypress="javascript:if(event.keyCode == 13) { parent.searchGrid(); }"/>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
            <div class="dj-input-group">
                <span class="info componentsFont">힌트</span>
                <input type="text" class="componentsSelect" id="log_attrib" name="log_attrib" onKeypress="javascript:if(event.keyCode == 13) { parent.searchGrid(); }"/>
            </div>
        </div>
