...
<div class="dj-card" id="filter">
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
            <div class="dj-input-group">
                <span class="info componentsFont">부수용가 번호</span>
                <input type="text" class="componentsSelect" id="child_admin_no" onKeypress="javascript:if(event.keyCode == 13) { parent.searchGrid(); }"/>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
            <div class="dj-input-group">
                <span class="info componentsFont">부수용가 명</span>
                <input type="text" class="componentsSelect" id="child_cust_nm" onKeypress="javascript:if(event.keyCode == 13) { parent.searchGrid(); }"/>
            </div>
        </div>
