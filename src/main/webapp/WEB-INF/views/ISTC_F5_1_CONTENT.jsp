    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-8 col-lg-12 col-xl-12">
            <div class="dj-btn-group">
                <button type="button" id = "searchbtn" class="btn dj-btn-primary btn-sm" onclick="parent.searchGrid(); siteinfogrid.search(); companyinfogrid.search(); blkinfogrid.search(); deleteCodegrid.search();">검색</button>
                <button type="button" onclick="openEditModal();" class="btn btn-sm dj-btn-outline-red"><i
                    class="ico i-user-plus"></i>사용자추가
                </button>
            </div>
        </div>
    </div>
