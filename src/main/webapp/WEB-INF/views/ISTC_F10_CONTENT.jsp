...
<%-- ISTC_F0_F1_2  2,4,6 필터 --%>
    ...
    <script>
        ...
        function loadComponentBase() {
            ...
            params.key = 7;
            baseComponent('mars.icbm.map1.selectComponentes', 'chkDay', params);
        }

        function changeDateOption(option) {
            if (option.value == '0') {
                $('#fromDateGroup').show();
            }
            else {
...
<div class="dj-card" id="filter">
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
            <div class="dj-input-group">
                <span class="info componentsFont">검침일</span>
                <select data-placeholder="전체" class="componentsSelect" id="chkDay" name="chkDay"
                        onchange="baseComponentChangHandler(this);">
                    <option value="-1" selected>전체</option>
                    <option value="-2">미지정</option>
                </select>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
            <div class="dj-input-group">
                <span class="info componentsFont">조회일자 기준</span>
                <select data-placeholder="전체" class="componentsSelect" id="dateOption" name="dateOption"
                        onchange="changeDateOption(this);">
                    <option value="0" selected>설정일 기준</option>
                    <option value="1">과금일 기준</option>
                </select>
            </div>
        </div>
