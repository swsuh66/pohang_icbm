    ...
    <div class="row">
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2" id ="statCd_Grp">
            <div class="dj-input-group" >
                ...
                <select data-placeholder="전체" class="componentsSelect" id="statCd" name="statCd"
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2" id ="useType_Grp">
            <div class="dj-input-group">
                ...
                <select data-placeholder="전체" class="componentsSelect" id="useType" name="useType"
                        onchange="baseComponentChangHandler(this);">
                    <option value="-1" selected>전체</option>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2" id ="blkSq_Grp">
            <div class="dj-input-group">
                ...
                <select data-placeholder="전체" class="componentsSelect" id="blkSq" name="blkSq"
                        onchange="baseComponentChangHandler(this);">
                    <option value="-1" selected>전체</option>
                    <option value="-2">미지정</option>
                </select>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2" id ="readOpr_Grp">
            <div class="dj-input-group" id ="readOpr_grp">
                ...
                <select data-placeholder="전체" class="componentsSelect" id="readOpr" name="readOpr"
                        onchange="baseComponentChangHandler(this);">
                    <option value="-1" selected>전체</option>
                    <option value="-2">미지정</option>
                </select>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2" id ="setYears_Grp">
            <div class="dj-input-group">
                ...
                <select data-placeholder="전체" class="componentsSelect" id="setYears" name="setYears"
                        onchange="baseComponentChangHandler(this);">
                    <option value="-1" selected>전체</option>
                    <option value="-2">미지정</option>
                </select>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2" id ="amiType_Grp">
            <div class="dj-input-group">
                ...
                <select data-placeholder="전체" class="componentsSelect" id="amiType" name="amiType"
                        onchange="baseComponentChangHandler(this);">
                    <option value="-1" selected>전체</option>
                    <option value="-2">미지정</option>
                </select>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2" id ="pipeDia_Grp">
            <div class="dj-input-group">
                ...
                <select data-placeholder="전체" class="componentsSelect" id="pipeDia" name="pipeDia"
                        onchange="baseComponentChangHandler(this);">
                    <option value="-1" selected>전체</option>
                    <option value="-2">미지정</option>
                </select>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2" id ="daysSelect_Grp">
            <div class="dj-input-group">
                <span class="info componentsFont">일자 범위</span>
                <select data-placeholder="전체" class="componentsSelect" id="daysSelect" name="daysSelect">
                    <option value="1" selected>1개월</option>
                    <option value="12">1년</option>
                </select>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2" id ="toDate_Grp">
            <div class="dj-input-group">
                <span class="info componentsFont">기준 일자</span>
                <input type="date" id="toDate">
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-8 col-lg-12 col-xl-12">
            <div class="dj-btn-group">
                <button type="button" id = "searchbtn" class="btn dj-btn-primary btn-sm" onclick="parent.searchGrid();">검색</button>
                <button type="button" id ="clearbtn" class="btn dj-btn-outline-gray btn-sm" onclick="resetComponentes();">초기화</button>
                <button type="button" id ="excelbtn" class="btn dj-btn-outline-green btn-sm" onclick="dataDownload();"><i class="ico i-excel"></i>엑셀다운</button>
            </div>
        </div>
    </div>
</div>
