    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2" id ="metcmp_Grp">
            <div class="dj-input-group">
                ...
                <select data-placeholder="전체" class="componentsSelect" id="metcmp" name="metcmp"
                        onchange="baseComponentChangHandler(this);">
                    <option value="-1" selected>전체</option>
                    <option value="-2">미지정</option>
                </select>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2" id ="searchInputCtn_Grp">
            <div class="dj-input-group">
                <span class="info componentsFont">단말기 번호</span>
                <input type="text" id="searchInputCtn" name="searchInputCtn" class="componentsSelect" onKeypress="javascript:if(event.keyCode == 13) { parent.searchGrid(); }"/>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-8 col-lg-12 col-xl-12">
            <div class="dj-btn-group">
                ...
                <c:if test="${user.getSiteLv() == 1}">
	                <button type="button" onclick="openModal();" class="btn btn-sm dj-btn-outline-primary"
	                        data-toggle="dropdown" data-display="static" aria-haspopup="true" aria-expanded="false"><i
