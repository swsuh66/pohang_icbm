    ...
    <div class="row">
		...
		<div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
            <div class="dj-input-group">
				...
				<input type="date" class="form-control" id="stdDate" name="stdDate" value="">   
            </div>
        </div>
		<div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
            <div class="dj-input-group">
                <span class="info componentsFont">기준시간</span>
				<input type="time" class="form-control" id="stdTime" name="stdTime" value="00:00:00" min="00:00:00" max="24:00:00">   
            </div>
        </div>
		<div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
            <div class="dj-input-group">
                <span class="info componentsFont">설정 시간</span>
                <input type="text" class="form-control" name="calc_hour" id="calc_hour" value="72" onKeypress="javascript:if(event.keyCode == 13) { parent.searchGrid(); }"/>
            </div>
        </div>
		<div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
            <div class="dj-input-group">
		...
		<div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
            <div class="dj-input-group">
                ...
                <select data-placeholder="선택" class="form-control" name="1" id="business_name" data-component="pipe_diameter">
                    <!--
                        <option value="" selected>전체</option>							
                        -->
				</select>
		...
		<div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
            <div class="dj-input-group">
                <span class="info componentsFont">설정 최소사용량</span>
                <input type="text" class="form-control" name="compare_term_cv" id="compare_term_cv" value="0.01" onKeypress="javascript:if(event.keyCode == 13) { parent.searchGrid(); }"/>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
            <div class="dj-input-group">
                <span class="info componentsFont">계량기 누수 상태 포함 여부</span>
                <select data-placeholder="선택" class="form-control" name="statYn" id="statYn" data-component="statYn">
                        <option value="" selected>전체</option>							
        ...
        <div class="col-12 col-sm-6 col-md-8 col-lg-12 col-xl-12">
            <div class="dj-btn-group">
				...
				<!--
					<button type="button" class="btn dj-btn-outline-gray btn-sm" onclick="openSettingModal();"><i class="ico i-set"></i>누수 설정</button>
					-->
