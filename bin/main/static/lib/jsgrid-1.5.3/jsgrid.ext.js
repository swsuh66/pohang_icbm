    ...
    Grid.prototype = {
        ...
        loadData: function(filter) {
            ...
            return this._controllerCall("loadData", filter, args.cancel, function(loadedData) {
                ...
                this._callEventHandler(el.onDataLoaded, {
                    data: loadedData
                });
            });
        },
        ...
        _dataToCsv: function(options){
            ...
            if (includeHeaders){
                ...
                */
                var headerLine = this._itemToCsv(null, this.fields, options);
        ...
        _itemToCsv_old: function(item, fields, options){
            var options = options || {};
            var delimiter = options.delimiter || "|";
            var encapsulate = options.hasOwnProperty("encapsulate") ? options.encapsulate : true;
            var newline = options.newline || "\r\n";
